<div id="addModal" class="reveal-modal">
	...
	<form method="post" action="AddNewBd">
		...
		<input type="text" id="titreBd" name="titreBd" value="" size="30" required/>
		<br/>
		
		<label for="serieBd">Serie </label>
		<input type="text" id="serieBd" name="serieBd" value="" size="30"/>
		<br/>
		
		<label for="scenarioBd">Scenario </label>
		<input type="text" id="scenarioBd" name="scenarioBd" value="" size="30" required/>
		<br/>
		
		<label for="dessinBd">Dessin </label>
		<input type="text" id="dessinBd" name="dessinBd" value="" size="30" required/>
		<br/>
		
		<label for="couleursBd">Couleurs </label>
		<input type="text" id="couleursBd" name="couleursBd" value="" size="30" required/>
		<br/>
		
		<label for="editeurBd">Editeur </label>
		<input type="text" id="editeurBd" name="editeurBd" value="" size="30" required/>
		<br/>
		...
		<input type="text" id="isbnBd" name="isbnBd" value="" size="30"/>
		<br/>
